...
//建構攝影機(透視投影的攝影機)
let camera = new THREE.PerspectiveCamera(10, document.getElementById("KLA").clientWidth / document.getElementById("KLA").clientHeight, 0.1, 50);
camera.position.x = 0;
...
/**
 * adjustHipPosition用處 : detector跟editor屁股位置之間的誤差  
 */
